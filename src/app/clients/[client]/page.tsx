...
import { Hosting } from "@/app/hosting/data/hosting";
...
export const generateStaticParams = async () =>
  Hosting.map((client) => ({ slug: slugify(client.client) }));
...
export default function Page({ params }: { params: { client: string } }) {
  ...
  // const client = newArray.find((client) => client.client === params.client);

  const client = Hosting.find(
    (client) => slugify(client.client) === params.client
  );
          ...
          <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
            <div className="mx-auto flex max-w-2xl items-center justify-between gap-x-8 lg:mx-0 lg:max-w-none">
              <div className="flex items-center gap-x-6">
                ...
                <h1>
                  <a
                    className="text-sm hover:text-gray-400 leading-6 text-gray-500"
                    href={client.siteURL}
                  >
                    {client.siteURL}
                  </a>
